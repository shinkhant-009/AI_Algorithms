...
int Puzzle::h(heuristicFunction hFunction){
	...
	switch(hFunction){
		...
		case manhattanDistance:
				...
				// implemented: calculate manhattan distance ***

				// for current tile looping
				for (int i=0; i < 3; i++){
					for (int j=0; j < 3; j++){
						...
						// for goal tile looping
						for(int row=0; row <3; row++){
							for (int  col=0; col < 3; col++ ){
								int goalTile = goalBoard[row][col];

								// is same number in different place
