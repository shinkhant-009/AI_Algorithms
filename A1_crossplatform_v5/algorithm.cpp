    ...
    while (!Q.empty())
    {
        ...
        if (current->canMoveUp())
        {
            ...
            else
            {
                ...
                // if the child board is not already expanded
                else
                {
                    ...
                    if (existingIndex != -1)
                    {
                        ...
                        // if the child g cost is not less than the existing node g cost, delete the child
                        else
                        {
                            delete child;
                        }
                    }
                    // if the child board is not in Q, push the child node onto the heap
                    else
                    {
